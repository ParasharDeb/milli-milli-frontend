...
const COURSES: { heading: string; blurb: string; items: Course[] }[] = [
  {
    ...
    items: [
      { name: "Bread, cultured butter, smoked salt", note: "Sourdough baked at seven, still warm at eight", price: "5", dot: "bg-amber", badge: "V" },
      { name: "Charred leeks, hazelnut, aged sheep", note: "Vinaigrette made from last week's wine", price: "9", dot: "bg-basil", badge: "V" },
      { name: "Scarlet prawn, lemon, olive oil", note: "Landed at Cascais this morning, served raw", price: "16", dot: "bg-ember" },
      { name: "Tomatoes, oregano, stale bread", note: "Six varieties, none of them round", price: "11", dot: "bg-terracotta", badge: "V" },
    ],
  },
  {
    heading: "Larger",
    ...
    items: [
      { name: "Salmon, saffron couscous, avocado", note: "The plate the room is named for", price: "24", dot: "bg-ember", badge: "Signature" },
      { name: "Grain bowl, market vegetables, herbs", note: "Whatever the growers had most of", price: "14", dot: "bg-basil", badge: "V" },
      { name: "Hearth bream, brown butter, capers", note: "Whole fish, for two, thirty minutes", price: "38", dot: "bg-terracotta", badge: "For 2" },
      { name: "Pork shoulder, quince, mustard greens", note: "Six hours over oak, finished on the grill", price: "26", dot: "bg-ember" },
    ],
  },
  {
    heading: "To finish",
    ...
    items: [
      { name: "Burnt honey tart, crème fraîche", note: "Honey from the hills behind Sintra", price: "8", dot: "bg-amber" },
      { name: "Sheep's milk ice cream, olive oil", note: "Three ingredients, one of them salt", price: "7", dot: "bg-basil", badge: "V" },
      { name: "Azeitão, quince paste, crackers", note: "Ripened down the road, spooned not sliced", price: "10", dot: "bg-terracotta", badge: "V" },
    ],
  },
];

const WINE = [
  ["Vinho verde, Quinta da Lixa", "Minho, 2024", "5 / 26"],
  ["Orange, curtimenta blend", "Alentejo, 2022", "7 / 34"],
  ["Baga, old vines", "Bairrada, 2019", "8 / 39"],
  ["Moscatel, twenty years", "Setúbal, NV", "6 / —"],
];
          ...
          <Reveal delay={0.1}>
            <div className="rounded-2xl border border-line bg-cream p-6">
              <p className="text-[15px] leading-relaxed text-muted text-pretty">
                ...
                <span className="font-medium text-ink">€58 a head</span> — the
